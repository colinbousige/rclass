...
But the installation is a tad complicated for the non initiate, and, well, it is just like Rmarkdown and Quarto but less easy to use and share, in my opinion. 
...
All your `Rmd` files should be directly compatible with quarto upon changing the extension name to `qmd`. 
