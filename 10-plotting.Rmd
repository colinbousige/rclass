...
- Plot the 4 spectra on top of each other with a vertical shift of 1, with a different color for each spectrum
    + For this use at the `factor()` function:
...
- Annotate on the base line with the name of the file. For this, use at `annotate("text", x, y, label)`
...
- Make a plot similar to this one (don't bother with the fit):
