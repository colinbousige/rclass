...
Finally, I also made some interactive exercises that are bundled in the [`tutoR`](https://github.com/colinbousige/tutoR) package. I let you go there and follow the instructions for installing it – you have to get used to going to GitHub to install packages and find information on them.
