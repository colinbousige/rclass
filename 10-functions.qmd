...
While an explicit call to `return()`{.R} is not necessary, I think it's usually a good prectise to write it explicitly to make clearer to the reader what the function actually returns.
