...
```{r pythonenv, echo=FALSE, fig.cap="An exaggeration? I think not... Source: [xkcd](https://xkcd.com/1987/).", fig.align="center", out.width="65%"}
knitr::include_graphics("./Plots/python_environment.png")
```
