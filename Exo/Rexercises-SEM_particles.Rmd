...
> In case you didn't manage to get there, [here](Data_SEM/particles.dat) is the `particles` tibble (it doesn't contain the units though as you can't save it in a text file.)
