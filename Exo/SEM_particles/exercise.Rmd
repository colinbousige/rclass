...
These wafers were then observed by scanning electron microscopy, and different images of the surface were taken: these images were analyzed with [ImageJ](https://imagej.net/Welcome), as shown on Figure \@ref(fig:SEMimages). With this analysis, we obtained a set of files of type `[x]nmNi-T[y]-[z]min-[u].csv`, where:
...
```{r SEMimages, echo=FALSE, message=FALSE, fig.cap="Typical SEM image of Ni nanoparticles: from the raw image to particle analysis", fig.align="center", out.width="85%"}
...
```{r include=params$solution, warning = FALSE, message=FALSE, out.width="100%"}
alldata %>%
