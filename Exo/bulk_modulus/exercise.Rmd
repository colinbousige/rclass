...
10. Using `nls()`{.R}, fit the experimental data of the volume relative variation with the Murnaghan equation of state. Make sure to add an amplitude parameter $A$ (that should be close to 1) to allow for more leeway on the fit, and use the proper weighing ($1/\sigma^2_{V/V_0}$). We fix the derivative value at $Kp=4$. The bulk modulus $K$ should be of the order of a few GPa, so work with pressures in GPa.
