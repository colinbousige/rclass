...
2. Load the `tidyverse` library and, using `read_csv()`, load the 4 datasets in 4 separate data.frames called `children`, `income`, `pop` and `religion`.
...
4. Using `pivot_longer()`, make all datasets tidy. 
