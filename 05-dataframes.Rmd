...
Here are some examples, and you will find much more [here](https://dplyr.tidyverse.org/). Take a look at the cheatsheet there, it's really helpful. Note the use of the pipe operator, `%>%`{.R}, that allows a clear syntax for successive operations:
...
dt2
inner_join(dt,dt2)
# merge tables row-wise, even if there are missing rows
...
# separate columns into multiple ones based on separators
