...
```{r}
Pressures1 <- read_table("Data/PY02_pressures.dat") %>% mutate(sample= 'PY02')
Pressures2 <- read_table('Data/PY02bis_pressures.dat') %>% mutate(sample= 'PY02bis')
...
data <- read_table(flist)

data1 <- read_table('Data/PY02_P1.dat')
