...
```{r}
PY02_pressures<-read.table("/NEW/Data/PY02_pressures.dat",header=TRUE)
PY02_pressures
PY02bis_pressures<-read.table("/NEW/Data/PY02bis_pressures.dat",header=TRUE)
PY02bis_pressures
library(dplyr)
PY02_pressures_tidy<- PY02_pressures%>%
...
Pressures<-rbind(PY02bis_pressures,PY02_pressures_tidy)
 Pressures
