...
```{r}
flist <- list.files(path="C:/Users/carlo/Downloads/exam2020/Data", pattern=".dat")
flist
```
...
PY02 <- read.csv("C:/Users/carlo/Downloads/exam2020/Data/PY02_pressures.dat") %>%
   mutate(sample="PY02") %>% 
   separate("run....P.kbar", c("run","P.kbar"), convert = TRUE) 


PY02bis <- read.csv("C:/Users/carlo/Downloads/exam2020/Data/PY02bis_pressures.dat") %>%
