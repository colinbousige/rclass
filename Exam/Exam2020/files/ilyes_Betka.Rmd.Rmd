...
```{r}
a<-read_table2("Data/PY02bis_P1.dat")
b<- read_table2("Data/PY02bis_P2.dat")
c<-read_table2("Data/PY02bis_P3.dat")
d<-read_table2("Data/PY02bis_P4.dat")
e<- read_table2("Data/PY02bis_P5.dat")
a1<- read_table2("Data/PY02_P1.dat")
a2<- read_table2("Data/PY02_P2.dat")
a3<- read_table2("Data/PY02_P3.dat")
a4<-  read_table2("Data/PY02_P4.dat")
a5<- read_table2("Data/PY02_P5.dat")
a6<- read_table2("Data/PY02_P6.dat")
a7<- read_table2("Data/PY02_P7.dat")
a8 <- read_table2("Data/PY02_P8.dat")
a9<- read_table2("Data/PY02_P9.dat")
a10<- read_table2("Data/PY02_P10.dat")
a11<- read_table2("Data/PY02_P11.dat")

flist<- c(a,b,c,d,e,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11)
...
d <- read_table2("Data/PY02_pressures.dat")
f <- read_table2("Data/PY02bis_pressures.dat")
d <- d %>% mutate(sample="PY02")
f <- f %>% mutate(sample= "PY02bis")
Pressures <- rbind(d,f)
