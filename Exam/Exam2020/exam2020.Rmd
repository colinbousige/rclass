...
7. We are interested in the position of the first peak around $q=1.8$ Å$^{-1}$. Create the `pospeak` tibble that stores the position `Q` of the maximum of each diffractogram. 
    - Make sure to filter data for scattering vectors below 2.5 Å$^{-1}$. 
    - For each file, create the column `Q` storing the position of the maximum in intensity.
    ...
    - Add the columns `run` and `sample` that contain the run number and sample name for each file (using the function `separate(column_name, c("sample","run","extension"))`{.R}). Make sure the column `run` contains a number, and get rid of the `extension` column.
...
pospeak <- read_table2("sample     run    Q   dQ    P.kbar    P
   PY02   1 1.802587 0.003839376   0.00 0.000
   PY02   2 1.840981 0.003839376   2.40 0.240
   PY02   3 1.875535 0.003839376   8.80 0.880
   PY02   4 1.875535 0.003839376  15.90 1.590
   PY02   5 1.890893 0.003839376  27.75 2.775
   PY02   6 1.929286 0.003839376  36.00 3.600
   PY02   7 1.936965 0.003839376  40.00 4.000
   PY02   8 1.971520 0.003839376  51.00 5.100
   PY02   9 1.902411 0.003839376  23.00 2.300
   PY02  10 1.867856 0.003839376   7.50 0.750
   PY02  11 1.802587 0.003839376   0.10 0.010
PY02bis   1 1.821784 0.003839376   0.00 0.000
PY02bis   2 1.883214 0.003839376   3.00 0.300
PY02bis   3 1.883214 0.003839376  16.00 1.600
PY02bis   4 1.933126 0.003839376  38.00 3.800
PY02bis   5 1.971520 0.003839376  48.00 4.800")
```
