...
confirmed_raw <- read_csv("Data/confirmed_raw.csv")

deaths_raw <- read_csv("Data/deaths_raw.csv")
```
...
confirmed2 <- read_csv("Data/covid_confirmed.csv")

deaths2 <- read_csv("Data/covid_deaths.csv")
