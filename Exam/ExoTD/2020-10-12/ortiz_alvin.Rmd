...
children <- read_csv("children_per_woman_total_fertility.csv"); children
income <- read_csv("income_per_person_gdppercapita_ppp_inflation_adjusted.csv"); income
pop <- read_csv("population_total.csv"); pop
