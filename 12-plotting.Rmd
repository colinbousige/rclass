...
... or `facet_grid(variable1~variable2)`{.R} if you want to see one variable as a function of another:
...
Interactive exercises can be found in the [`tutoR`](https://github.com/colinbousige/tutoR) package. For this, if you haven't already, run:
...
Then launch the tutorial by running:
