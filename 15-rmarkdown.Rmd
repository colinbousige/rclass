...
- [vitae](https://github.com/mitchelloharawild/vitae): a package to write your CV using Rmarkdown, with helpful functions to add content to the documents.
...
- HTML outputs:
    ...
    - [BS4 book (like this class)](https://github.com/colinbousige/Rclass/tree/master/RmdExamples/html_bs4book)
...
- PDF outputs:
    - [Document with template](https://github.com/colinbousige/Rclass/tree/master/RmdExamples/pdf_with_template)
