...
- [The Rmarkdown website gallery](https://rmarkdown.rstudio.com/gallery.html): to help you chose between formats and templates, with example codes
...
- [The Rmarkdown definitive guide](https://bookdown.org/yihui/rmarkdown/): just go there when you have a question about Rmarkdown.
- [flexdashboard](https://pkgs.rstudio.com/flexdashboard/): the package to make dashboards
- [rticles](https://github.com/rstudio/rticles): package with a collection of pdf templates for scientific articles
- [rmdformats](https://github.com/juba/rmdformats): package with a collection of html templates
- [stevetemplates](http://svmiller.com/stevetemplates/): a collection of pdf templates by Steve Miller
- [Rexams](http://www.r-exams.org/): to help define exams with included solution
- [Thesisdown](https://github.com/ismayc/thesisdown): a package to write your thesis with Rmarkdown

I also provide a collection of examples on the [github repo of this class](https://github.com/colinbousige/Rclass/RmdExamples):
- HTML outputs:
    - [Simple page](https://github.com/colinbousige/Rclass/RmdExamples/html_page)
    - [Dashboard](https://github.com/colinbousige/Rclass/RmdExamples/html_dashboard)
    - [Gitbook](https://github.com/colinbousige/Rclass/RmdExamples/html_gitbook)
    - [BS4 book (like this class)](https://github.com/colinbousige/Rclass/RmdExamples/html_bs4book)
    - [Book](https://github.com/colinbousige/Rclass/RmdExamples/html_book)
    - [ioslide](https://github.com/colinbousige/Rclass/RmdExamples/html_ioslide)
- PDF outputs:
    - [Document with template](https://github.com/colinbousige/Rclass/RmdExamples/pdf_with_template)
    - [Beamer presentation](https://github.com/colinbousige/Rclass/RmdExamples/pdf_beamer_presentation)
    - [Book](https://github.com/colinbousige/Rclass/RmdExamples/pdf_book)
    - [Exercises with hidden solution](https://github.com/colinbousige/Rclass/RmdExamples/pdf_exercises_with_hidden_solution)
- Microsoft Office outputs:
    - [PowerPoint](https://github.com/colinbousige/Rclass/RmdExamples/powerpoint)
    - [Word (with template)](https://github.com/colinbousige/Rclass/RmdExamples/word_with_template)
