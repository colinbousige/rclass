...
Avoiding loops should therefore be sought for when possible. R helps us in this way through the base functions `apply()`{.R}, `sapply()`{.R} and `lapply()`{.R}. [Operations in the `tidyverse`{.R}](#operations-in-the-tidyverse) are also a good way of avoiding loops. 
